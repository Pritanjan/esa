          ...
          <div className="flex-1 h-full px-4 flex flex-col gap-6 overflow-y-auto rounded-lg">
            ...
            >
              ...
              <div className="flex items-center justify-between py-4 ">
                <label
                  htmlFor="imgUpload"
                  className="flex item-center gap-1 text-ascent-2 hover:text-ascent-1 cursor-pointer"
                >
                  <input
                    type="file"
                ...
                <label
                  htmlFor="videoUpload"
                  className="flex item-center gap-1 text-base text-ascent-2 hover:text-ascent-1 cursor-pointer"
                >
                  <input
                    type="file"
                    onChange={(e) => setFile(e.target.files[0])}
          ...
          <div className="w-1/4 h-full lg:flex flex-col gap-8 overflow-y-auto">
            <div>
              ...
              <div className="w-full bg-primary shadow-sm rounded-lg px-6  py-5">
                <div className="flex items-center justify-between text-x1 text-ascent-1 pb-2 border-b border-[#66666645]">
                  ...
                  {friendRequest?.map(({ _id, requestFrom }) => (
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        <CustomButton
                          title="Accept"
                          containerStyles="bg-[#0444a4] text-x5 text-white px-1.5 py-1 rounded-full"
                        />
                        <CustomButton
                          title="Deny"
                          containerStyles="border border-[#666] text-x5 text-white px-1.5 py-1 rounded-full"
                        />
                      </div>
                    </div>
                  ))}
                ...
                <div className="w-full flex flex-col gap-4 pt-4">
                  {suggestedFriends?.map((friend) => (
                    ...
                    >
                      ...
                      <div className="flex gap-1">
                        <button
                          className="'bg-[#04444a430] text-sm text-white p-1 rounded"
                          onClick={() => {}}
                        >
                          <BsPersonFillAdd
                            size={20}
